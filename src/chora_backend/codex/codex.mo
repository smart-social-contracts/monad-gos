/// Chora Codex v0.1.0 — authored by the Monad.
///
/// Public source of truth (version control):
///   https://github.com/smart-social-contracts/chora-gos
///   src/chora_backend/codex/codex.mo
///
...
module {
  ...
  public let TREASURY_NAME : Text = "chora";
  public let SOURCE_PATH : Text = "src/chora_backend/codex/codex.mo";
  public let SOURCE_REPO : Text = "https://github.com/smart-social-contracts/chora-gos";
